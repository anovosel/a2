        ...
        },
        {
            ...
            classMethods: {
                associate: function (models) {
                    ...
                    questionSQL.belongsTo(models.user, {as: "lastEditedBy", foreignKey:"lastEditedById"});
                    questionSQL.belongsTo(models.questionSQL, {as: "previous", foreignKey:"previousQuestionId"});
                }
            }
        });
